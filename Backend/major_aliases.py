...
flagged app.py/planner_engine.py for splitting. Zero behavior change: the
JSON-load-then-immediately-overwrite pattern below is preserved exactly as
it was in app.py, not "fixed" as part of this move.
"""
